...
def door_open():
    ...
    while not final_end_answer == "sound":
        print(Fore.RED + "Wrong word, type sound.\n")
        door_open()

    print(
        Fore.BLUE + "With a scream, you are startled awake."
...
def inside_the_ship():
    ...
    if question_six == "a":
        ...
        print(
            ...
            "Go back through the hatch and onto the upperdeck?")
...
def walking_the_upperdeck():
    ...
    if question_seven == "a":
        print(
            Fore.YELLOW + choices[1] +
            "Chase the figure to see what its doing?\n")
        chase_the_figure()
...
def see_a_figure():
    ...
    clear()
    print(
        Fore.BLUE + "Whilst your drifting around this huge,"
    ...
    if question_three == "a":
        ...
        print(
            Fore.YELLOW + choices[2]
            "Take your boat futher away from the Warship?")
        coastguard()
    else:
        print(Fore.RED + choices[0])
        see_a_figure()
...
def friends_arrive():
    ...
    explouration of the ship question four
    """
    clear()
    print(
        Fore.BLUE + "Your friends are by your side,"
...
def coastguard():
    ...
    if question_five == "a":
        print(Fore.YELLOW + choices[1] + "Walk the upperdeck with them?\n")
        walking_the_upperdeck()
    elif question_five == "b":
        print(
            Fore.YELLOW + choices[2] + "Take your boat futher away "
            "from the Warship?")
        end_game('non final')
    else:
        print(Fore.RED + choices[0])
...
def quit_game():
    ...
    """
    clear()
    print("You have decided to Quit the game, Thanks for playing.\n")
...
def game_intro():
    ...
    print(
        Fore.BLUE + "Warship is designed for you to "
        "move through the different paths\n")
    menu()
...
def menu():
    ...
    if menu_answer == "a":
        ...
        print(
            Fore.RED + "Invalid Entry, please select "
            "the correct input using a, b or c")
        game_intro()
